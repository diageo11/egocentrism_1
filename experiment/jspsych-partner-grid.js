...
jsPsych.plugins['partner-grid'] = (function() {
  ...
  var requestedfile = "";
  var rawGrid;
  var lastAudioClip = [0,0,0,0,0,0,0];
  jsPsych.pluginAPI.registerPreload('partner-grid', 'stimuli', 'image', 'audio');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var thePicnum =  fillernums[randomIndex];
    var prevVariation = lastAudioClip[randomIndex];
    
    var variation;
    console.log("last variation for clip " + thePicnum + " was " + prevVariation);
    do{
        variation = Math.floor(Math.random()*Math.floor(4))+1; //Number betwixt 1 and 4
        console.log("generated " + variation);
    }while (variation == prevVariation);
    lastAudioClip[randomIndex] = variation;
    
    var picstring = String("(" + thePicnum +")" + variation);
    console.log("File is " + picstring);
      
    var filename = String ("img/stimuli/" + picstring+ ".wav"); 

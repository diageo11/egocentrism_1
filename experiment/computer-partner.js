...
"img/stimuli/(8)c.ogg",
"img/stimuli/(9)c.ogg",
"img/stimuli/(10)c.ogg",
"img/stimuli/(11)c.ogg",
"img/stimuli/(12)c.ogg",
"img/stimuli/(13)c.ogg"];
...
var practimeline = [timedcircle, partnerproc, practiceproc, partnerproc, practiceproc, partnerproc, practiceproc, partnerproc, practiceproc, partnerproc, practiceproc, partnerproc, practiceproc];
...
var reject_part = {
	timeline: [{
		type: 'html-keyboard-response',
		choices: jsPsych.NO_KEYS,
		stimulus: 'Unfortunately you have not met the requirements for this experiment and are not eligible to participate.'
    }],
...
timeline.push(info2, consent, exclusion, reject_part, instructions,
              prepractice, initialize, practimeline, postpractice, initialize, expproc,demographic,debrief, payment);

...
jsPsych.plugins["picture-match"] = (function () {
    ...
    plugin.trial = function (display_element, trial) {
        ...
        if (trial.info.turn == 'partner') {
            ...
            html += `<p>Press the LEFT or RIGHT arrow to select the image described by your partner. </p>`;
            ...
            html += `<p>Press SPACE after you've described out loud the highlighted image to your partner.</p>`;
